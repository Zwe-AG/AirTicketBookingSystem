...
<section>
    ...
    <div style="height:100vh" id="download">
        <div class="boarding-pass">
            <header>
                ...
                <div class="flight">
                    <small>flight</small>
                    <strong>{{$bookings[0]->flight_name}}</strong>
                </div>
            </header>
            <section class="cities">
                <div class="city">
                    {{-- <small>Roma</small> --}}
                    <strong>{{Str::substr($bookings[0]->city_from,0,3)}}</strong>
                </div>
                <div class="city">
                    {{-- <small>Napoli</small> --}}

                    <strong>{{Str::substr($bookings[0]->city_to,0,3)}}</strong>
                </div>
                <svg class="airplane">
            ...
            <section class="infos">
                <div class="places">
                    ...
                    <div class="box">
                        <small>Class</small>
                        <strong style="font-size: 13px">{{$bookings[0]->flight_class}}</strong>
                    </div>
                </div>
                <div class="times">
                    <div class="box">
                        <small>Boarding</small>
                        <strong>{{date('h:i',strtotime($bookings[0]->flight_boarding_time))}}</strong>
                    </div>
                    <div class="box">
                        <small>Departure</small>
                        <strong>{{date('h:i',strtotime($bookings[0]->flight_departure_time))}}</strong>
                    </div>
                    <div class="box">
                        <small>Duration</small>
                        <strong>{{date('h:i',strtotime($bookings[0]->flight_duration))}}</strong>
                    </div>
                    <div class="box">
                        <small>Arrival</small>
                        <strong>{{date('h:i',strtotime($bookings[0]->flight_arrival_time))}}</strong>
                    </div>
                </div>
            </section>
            <section class="strap">
                <div class="box">
                    ...
                    <div class="date">
                        <small>Date</small>
                        <strong>{{date('N, j F Y',strtotime($bookings[0]->flight_departure_time))}}</strong>
                    </div>
                </div>
                <svg class="qrcode">
