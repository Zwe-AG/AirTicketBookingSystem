                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-4">
                                ...
                                <!-- Account -->
                                <div class="card-body">
                                    <form id="formAccountSettings" action="{{route('admin#accountprofileupdate',Auth::user()->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <hr class="mb-3" />
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <a href="{{route('admin#mainpage')}}" class="btn btn-outline-secondary">Go to back</a>
