			...
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="{{ route('login') }}" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter email">
						<input class="input100" type="email" name="email" placeholder="User email" autocomplete="off">
                ...
                <div style="text-align:center;margin-top:20px">
                    <p style="text-align:center;color:white">not already register <strong><a href="{{ route('auth#registerPage') }}" style="color:white;font-size:17px">Register Now</a></strong></p>
                    <p style="text-align:center;color:white"><a href="{{route('otp#page')}}" style="color:white;font-size:17px">Forgot Password ?</a></strong></p>
                </div>
			</div>
		</div>
	</div>
