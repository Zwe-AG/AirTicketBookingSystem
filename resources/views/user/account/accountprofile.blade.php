    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="{{route('user#home')}}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{route('user#accountprofilepage')}}"> Profile</a></p>
            </div>
        </div>
    </div>
</section>
                                    ...
                                    <hr class="mb-3" />
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <input class="form-control" type="number" id="phone" name="phone" value="{{old('name',Auth::user()->phone)}}" disabled/>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="email" class="form-label">E-mail</label>
                                                <input class="form-control" type="email" id="email" name="email" value="{{old('name',Auth::user()->email)}}" disabled/>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                                <label for="organization" class="form-label">Address</label>
                                                <input type="text" class="form-control" id="organization" name="address" value="{{old('name',Auth::user()->address)}}" disabled/>
                                            </div>
                                            <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mt-2">
                                            <a href="{{route('user#accountprofileedit')}}" class="btn btn-primary me-2">Edit Profile</a>
